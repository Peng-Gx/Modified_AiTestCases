...
sta = state.TestCaseGenerationState(prd_content=text, detected_testPoint=[], generated_cases=[], evaluation_report={}, optimization_hints=[])
llm, embeddings = llm_initial.initialize_llm()
detected = Generator.detector_agent_node(sta, llm)
...
for i in range(len(detected)//clip+1):
    ...
    sta["detected_testPoint"] = detected[begin:end]
